...
(() => {
    document.addEventListener('DOMContentLoaded', () => {
      ...
      //  const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inpqd25mYmhuZW1laGl4aGl1cGV5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA1MzIxMzgsImV4cCI6MjA3NjEwODEzOH0.3cNnBxWPVvpfr0vcFvbr2fxz2y20ZW2GNS6IZS6pHK0"
        let access_token = '';
     ...
     /*   let token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..lFTwGO-2dbhPMg7XBMg2EXU4iBjmeQrvWMbbw798GPE"
        fetch('https://zjwnfbhnemehixhiupey.supabase.co/rest/v1/graphs',{ 
            method: 'get',
            headers: {
            ...
            document.querySelector('#signupbtn').addEventListener('click',async ()=>{
                ...
                let response = await fetch('https://zjwnfbhnemehixhiupey.supabase.co/auth/v1/signup',{
                    method: 'post',
                    headers: {
                        "apiKey": SUPABASE_KEY,
            ...
            document.querySelector('#loginbutton').addEventListener('click',async ()=>{
                ...
                let response = await fetch('https://zjwnfbhnemehixhiupey.supabase.co/auth/v1/token?grant_type=password',{
                    method: 'post',
                    headers: {
                        "apiKey": SUPABASE_KEY,
                        "Content-Type": "application/json",
            ...
            document.querySelector('#pedirDatos').addEventListener('click',()=>{
                fetch('https://zjwnfbhnemehixhiupey.supabase.co/rest/v1/products?select=*',{ 
                    method: 'get',
                    headers: {
                        "apiKey": SUPABASE_KEY,
